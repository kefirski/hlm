...
class TwitterLoader():
    def __init__(self, data_path='', force_preprocessing=False):
        """
        :param data_path: path to twitter data
        ...
        self.data_files = [data_path + path for path in ['test.txt', 'train.txt']]
        self.target_idx = {'valid': 0, 'train': 1}

        self.idx_file = self.preprocessings_path + 'twitter_vocab.pkl'
